...
language_map =
    [
        {'change_language': "切换至中文", 'page_title': "Wangpengroup Homepage", 'home': "Home", 'about': "About", 'research': "Research", 'partners': "Partners", 'contact': "Contact", 'team': "Team", 'prof_name': "Peng Wang (KOBY)", 'prof_title': "Prof. Peng Wang", 'about_me': "About Me", 'about_more': "Learn More", 'intro_1': "Professor of Mathematics, School of Mathematics and System Science, Beihang University", 'intro_2': "\“Thousand Talents Program\” Recipient", 'view_cv': "View My CV",
            'full_intro': "I am computational mathematician working on uncertainty quantification. We combines mathematical theory and state-of-the-art computational tools to solve scientific and engineering problems with domain scientists.", "background": "Background", 'education': "Education", 'employment': "Employment", 'position': "Position", 'projects': "Projects", 'subjects': "Subjects", 'goal': "Our goal is to develop mathematical tools to quantify uncertainty in nature, engineering systems and our society, and thus provide more accurate and comprehensive predictions of these system states. Applications of our work include environmental protection (flood prediction), ecology (algae blooms), oil recovery and renewable energy systems.", 'funding_info': "Funding Info", 'fundings': "Fundings", 'details': "Details", 'resources': "Resources", "contact_info": "Contact Info", 'rights': "© 2019 Wangpengroup. All Rights Reserved", 'banner_1_1': "We focus on",
            'banner_1_2': "Material Science", 'banner_2_1': "We study", 'banner_2_2': "Energy Profile", 'banner_3_1': "We simulate", 'banner_3_2': "Flow Dynamics", 'stochastic': "Stochastic", 'computation': "Computation", 'show_more': "Show More", 'show_less': "Show Less"},
        {'change_language': "English Version", 'page_title': "王鹏教授的实验室主页", 'home': "主页", 'about': "关于", 'research': "科研", 'partners': "合作", 'contact': "联系我们", 'team': "成员", 'prof_name': "王鹏 教授", 'prof_title': "王鹏 教授", 'about_me': "关于我", 'about_more': "了解更多", 'intro_1': "北京航空航天大学 数学与系统科学学院 教授", 'intro_2': "中组部“青年千人计划”专家", 'view_cv': "查看我的简历", "full_intro":
            ...
            "我们的研究核心是开发数学工具以量化自然、工程和社会系统中的不确定性，进而对这些系统状态做出更准确与全面的预测。我们研究的具体应用包含环境保护（洪水预测）、生态平衡（水华爆发）、石油开采和新能源系统。", 'funding_info': "经费详情", 'fundings': "经费", 'details': "详情", 'resources': "资源", "contact_info": "联系方式", 'rights': "© 2019 Wangpengroup. 保留所有权利", 'banner_1_1': "我们研究", 'banner_1_2': "材料科学", 'banner_2_1': "我们解决", 'banner_2_2': "能源问题",
            'banner_3_1': "我们模拟", 'banner_3_2': "流体力学", 'stochastic': "随机", 'computation': "过程", 'show_more': "显示更多", 'show_less': "隐藏"}
    ];
language_code = 0;
